...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference("Tarefa.count") do
      post tarefas_url, params: { tarefa: { description: @tarefa.description, done: @tarefa.done, due_date: @tarefa.due_date } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { description: @tarefa.description, done: @tarefa.done, due_date: @tarefa.due_date } }
